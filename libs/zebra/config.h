...
/* bfdd vty socket */
#define BFD_VTYSH_PATH "/var/run/bfdd.vty"

#define BCM_VTYSH_PATH "/var/run/bcmd.vty"
#define SAMPLE_VTYSH_PATH "/var/run/sample.vty"
#define LLDPD_VTYSH_PATH "/var/run/lldpd.vty"
...
#define PACKAGE_STRING "Quagga 0.99.24.1"
...
/* bfdd PID */
#define PATH_BFDD_PID "/var/run/bfdd.pid"

#define PATH_BCM_PID "/var/run/bcmd.pid"

#define PATH_SAMPLE_PID "/var/run/sample.pid"
...
/* ldpd PID */
#define PATH_LDPD_PID "/var/run/ldpd.pid"
